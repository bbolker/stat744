...
* Find a table (preferably a complicated one) and turn it into a graph. One option would be Table 3.3 of @mccallum_situ_2017; you can find most of (an earlier version of) the data for this graph [here](https://github.com/bbolker/stat744/blob/master/data/POCIS_Raw_McCallum.csv).
